...
window.UIMATE_I18N = {
  en: {
    ...
    "overview.lede": "An open-weight foundation GUI agent that pairs environment-grounded training with in-context demonstration learning — so users can show a procedure once instead of spelling every convention out in a prompt.",
    "overview.fig": "General computer use plus demo-guided execution. One demonstration lifts long-horizon task scores without turning the agent into a replay script.",

    "hl.osworld": "OSWorld-Verified · UI-Mate-27B",
    "hl.waa": "WindowsAgentArena · open-weight SOTA",
    "hl.worker": "OSWorkerBench strict success",
    "hl.demo": "Strict success with one demo",
    ...
    "approach.2.p": "Record once → captioned subtask workflow. At run time the live screenshot stays authoritative; the demo is guidance, not a script.",
    ...
    "flow.on.harness.p": "Holds the plan; exposes only the active subtask",
    ...
    "flow.on.note": "Harness keeps the checklist; after one or two subtasks finish, the agent emits completion and the run ends.",

    "kicker.results": "03 — Results",
    "res.title": "Open-weight CUA — and more reliable with one demo",
    "res.lede": "77.0% on OSWorld-Verified and 66.2% on WindowsAgentArena among open-weight models. On the OSWorkerBench paired subset, progress rises from 64.1% to 74.9% with one demonstration.",
    "res.m1.k": "OSWorld-Verified",
    "res.m1.n": "Open-weight SOTA",
    "res.m2.k": "WindowsAgentArena",
    "res.m2.n": "Open-weight SOTA",
    "res.m3.k": "OSWorkerBench",
    "res.m3.n": "Strict / progress · +17.7 / +24.5 vs base",
    "res.m4.k": "+ one demo",
    "res.m4.n": "Paired OSWorker subset · strict success",
    ...
    "cite.lede": "If UI-Mate, DemoCUA, or OSWorkerBench is useful in your research, please cite the technical report.",
    "cite.copy": "Copy",
    "cite.copied": "Copied",
  ...
  zh: {
    ...
    "hero.badge": "技术报告",
    "hero.title": "以上下文演示推进开源权重通用 GUI 智能体",
    "hero.tagline": "先把通用计算机使用做强；指令说不清时，再补一段演示。",
    ...
    "overview.lede": "开源权重的通用 GUI 智能体：环境驱动的训练栈，加上上下文演示学习——流程只需演示一次，不必把所有约定写进提示。",
    "overview.fig": "通用计算机使用 + 演示引导执行。一段演示提升长程任务分数，而不会把智能体变成回放脚本。",

    "hl.osworld": "OSWorld-Verified · UI-Mate-27B",
    "hl.waa": "WindowsAgentArena · 开源权重 SOTA",
    "hl.worker": "OSWorkerBench 严格成功率",
    "hl.demo": "一段演示后的严格成功率",
    ...
    "flow.on.harness.h": "Harness 工作流钩子",
    "flow.on.harness.p": "持有计划；只展开当前子任务",
    ...
    "flow.edge.next": "下一观测",
    "flow.edge.done": "subtask_complete",
    "flow.on.note": "Harness 维护 checklist；完成一两个子任务后发送完成信号，整段任务结束。",

    "kicker.results": "03 — 结果",
    "res.title": "开源权重 CUA —— 一段演示后更可靠",
    "res.lede": "OSWorld-Verified 77.0%，WindowsAgentArena 66.2%。在 OSWorkerBench 配对子集上，一段演示后进度分从 64.1% 提到 74.9%。",
    "res.m1.k": "OSWorld-Verified",
    "res.m1.n": "开源权重 SOTA",
    "res.m2.k": "WindowsAgentArena",
    "res.m2.n": "开源权重 SOTA",
    "res.m3.k": "OSWorkerBench",
    "res.m3.n": "严格 / 进度 · 相对基座 +17.7 / +24.5",
    "res.m4.k": "+ 一段演示",
    "res.m4.n": "OSWorker 配对子集 · 严格成功",
    ...
    "cite.title": "引用本工作",
    "cite.lede": "如果 UI-Mate、DemoCUA 或 OSWorkerBench 对你的研究有帮助，欢迎引用这份技术报告。",
    "cite.copy": "复制",
    "cite.copied": "已复制",
